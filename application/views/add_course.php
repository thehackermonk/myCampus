		...
		<div class="row">
			...
			<div class="col-6">
				...
				<div class="card card-body">
					<br>
					<form action="<?php echo base_url(); ?>index.php/add_course/addCourse" method="post">
						<div class="md-form">
							<input type="text" class="form-control" name="crsname" placeholder="Name" maxlength="35" required>
						</div>
						<div class="md-form">
							<textarea class="add_description" name="crsdesc" placeholder="Desciption" maxlength="250" required></textarea>
						</div>
						<center><input type="submit" class="btn btn-primary" value="Add Course"></center>
					</form>
					<br>
				</div>
			</div>
